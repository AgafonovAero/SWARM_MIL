...
rezultat_opyta.scenarii = scenarii;
rezultat_opyta.parametry_svyazi = parametry_svyazi;
rezultat_opyta.parametry_zvenev = parametry_zvenev;
rezultat_opyta.parametry_peredachi = parametry_peredachi;
