...
est_grafik_dopustimosti = ismember( ...
    'itog_dopustim', ...
    tablica.Properties.VariableNames);
...
figura_serii = figure( ...
    ...
    'Visible', rezhim_vidimosti, ...
    'Color', 'w');
if est_grafik_dopustimosti
    maket = tiledlayout(figura_serii, 3, 2, ...
        'Padding', 'compact', 'TileSpacing', 'compact');
    chislo_osei = 5;
else
    maket = tiledlayout(figura_serii, 2, 2, ...
        'Padding', 'compact', 'TileSpacing', 'compact');
    chislo_osei = 4;
end

osi = gobjects(1, chislo_osei);
...
if est_grafik_dopustimosti
    osi(5) = postroit_stolbcovyj_grafik( ...
        maket, ...
        podpisi, ...
        double(tablica.itog_dopustim), ...
        'Ресурсная допустимость вариантов', ...
        '0 - нет, 1 - да');
    ylim(osi(5), [0 1.05]);
end
